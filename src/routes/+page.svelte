	...
	:global {
		...
		*:after {
		...
		@font-face {
			font-family: Dazzed;
			src:
				url(../assets/fonts/Dazzed-Medium.woff2) format('woff2'),
		...
		body {
			...
			-moz-font-feature-settings: 'ss01', 'ss05';
			-webkit-font-feature-settings: 'ss01', 'ss05';
